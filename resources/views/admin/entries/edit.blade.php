        ...
        <div class="mx-auto max-w-4xl sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200">
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('admin.entries.update', $entry) }}" class="space-y-8">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="number" 
                                           name="shifting_in" 
                                           id="shifting_in" 
                                           value="{{ old('shifting_in', $entry->shifting_in) }}"
                                           min="0"
                                           step="1"
                                ...
                                <div>
                                    ...
                                    <input type="number" 
                                           name="shifting_out" 
                                           id="shifting_out" 
                                           value="{{ old('shifting_out', $entry->shifting_out) }}"
                                           min="0"
                                           step="1"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="number" 
                                           name="feed_in_stock" 
                                           id="feed_in_stock" 
                                           value="{{ old('feed_in_stock', $entry->feed_in_stock) }}"
                                           min="0"
                                           step="0.01"
                                ...
                                <div>
                                    ...
                                    <input type="number" 
                                           ...
                                           id="feed_consumption" 
                                           value="{{ old('feed_consumption', $entry->feed_consumption) }}"
                                           min="0"
                                           step="0.01"
                        ...
                        <div class="border-b border-gray-200 pb-6">
                            ...
                            <div>
                                ...
                                <textarea name="medication" 
                                          ...
                                          placeholder="Enter medication details, dosage, and any notes...">{{ old('medication', $entry->medication) }}</textarea>
                                @error('medication')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="number" 
                                           name="water_ph" 
                                           id="water_ph" 
                                           value="{{ old('water_ph', $entry->water_ph) }}"
                                           min="0"
                                           max="14"
                                           step="0.01"
                                ...
                                <div>
                                    ...
                                    <input type="number" 
                                           name="water_do" 
                                           id="water_do" 
                                           value="{{ old('water_do', $entry->water_do) }}"
                                           min="0"
                                           step="0.01"
                        ...
                        <div class="border-b border-gray-200 pb-6">
                            ...
                            <div>
                                ...
                                <input type="number" 
                                       name="offence_cases" 
                                       id="offence_cases" 
                                       value="{{ old('offence_cases', $entry->offence_cases) }}"
                                       min="0"
                                       step="1"
                        ...
                        <div class="pb-6">
                            ...
                            <div>
                                ...
                                <textarea name="additional_notes" 
                                          ...
                                          placeholder="Enter any additional notes or observations...">{{ old('additional_notes', $entry->additional_notes) }}</textarea>
