                    ...
                    <form method="POST" action="{{ route('admin.farms.store') }}">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                @enderror
                                @if($managers->isEmpty())
                                    <p class="mt-1 text-xs text-gray-500">No available managers. <a href="{{ route('admin.managers.create') }}" class="text-blue-600 hover:text-blue-900">Create a manager first</a>.</p>
                                @endif
                            </div>
