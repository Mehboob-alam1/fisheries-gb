<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('admin.managers.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                Create New Manager
            </a>
        </div>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                                ...
                                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                    @foreach($managers as $manager)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                                                {{ $manager->farm ? $manager->farm->name : 'N/A' }}
                                            </td>
                    ...
                    @else
                        <p class="text-gray-500 dark:text-gray-400">No farm managers found. <a href="{{ route('admin.managers.create') }}" class="text-blue-600 hover:text-blue-900">Create one now</a>.</p>
                    @endif
                </div>
            </div>
        </div>
